phase 1
NWE :Use your Private VPC to isolate our environment
create K8 : deploy application(scan it for vulnerability issues)
create VM: SonarQube, Nexus,Jenkins, monitoring tool
Phase 2
create Git repo( private)
Push our source code to it
the source code should be visible to us
Phase 3
create your CICD pipeline
follow your best practices
taking security measures
deployment of application
configure mail notification
Phase 4
monitoring the application(system level- CPU,RAM) , website leverl - traffic)
IMPLEMENTATION
